...
<body>
    <div class="header">
        <p class="uppercase bold d-block center b-p">Guest House | Laundry</p>
        ...
        <table class="w-100">
            ...
            <tr>
                ...
                <td class="left">{{ $data->customer->name }}</td>
                <td class="right">Kasir : </td>
                <td class="right"> {{\Auth::user()->name}}</td>
            </tr>
            <tr>
                <td></td>
                <td class="left" colspan="3">{{ date('d M, Y', strtotime($data->created_at)) }}</td>
            </tr>
            @endforeach
        </table>
        <hr class="hr-dash">
