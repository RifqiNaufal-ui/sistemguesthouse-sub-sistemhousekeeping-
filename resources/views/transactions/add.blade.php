...
<div class="row">
    <div class="col-md-12">
		...
		<form class="form-horizontal" id="yoyo" role="form" method="POST" action="{{ url('transactions/add') }}">
		...
		<table class="table table-striped">
			...
			<tbody class="neworderbody">
				...
				<td>
					<input type="number" class="dis form-control" name="dis[]" required="">
				</td>
				<td>
	...
	<hr>
	<td>Payment <input type="number" class="getmoney form-control" name="getmoney" value="{{ old('getmoney') }}" required=""></td>
	<td>Change <input type="number" class="backmoney form-control" name="backmoney" value="{{ old('backmoney') }}"></td>
	<hr>
