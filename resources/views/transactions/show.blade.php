        ...
        <div class="box box-warning">
            <div class="box-header">
                <p>
                   ...
                   <!-- <a href="{{ route('transactions.hapus') }}" class="btn btn-sm btn-flat btn-danger"><i class="fa fa-trash-o"></i> Delete</a> -->
                </p>
            </div>
            <div class="box-body">
                        ...
                        <tbody>
                         @foreach($transaction_details as $data)
                                <tr>
                                    ...
                                    <td><center><button href="{{ url('transactions/delete'.$data->id) }}" class="btn btn-danger btn-xs btn-hapus" id="delete"><i class="fa fa-trash-o"></i></button></center></td>
                                </tr>
                          @endforeach
                        </tbody>
                    </table>
