        ...
        <div class="box box-warning">
            <div class="box-header">
                <p>
                   ...
                   <!-- <a href="{{ route('orderrs.hapus') }}" class="btn btn-sm btn-flat btn-danger"><i class="fa fa-trash-o"></i> Delete</a> -->
                </p>
            </div>
            <div class="box-body">
                        ...
                        <tbody>
                         @foreach($orderrdetails as $data)
                                <tr>
                                    ...
                                    <td><center><button href="{{ url('orderrs/delete'.$data->id) }}" class="btn btn-danger btn-xs btn-hapus" id="delete"><i class="fa fa-trash-o"></i></button></center></td>
                                </tr>
                          @endforeach
                        </tbody>
                    </table>
