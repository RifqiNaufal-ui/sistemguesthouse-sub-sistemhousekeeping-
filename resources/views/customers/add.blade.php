    ...
    <div class="col-md-12">
        ...
        <div class="box box-warning">
            ...
            <div class="box-body">
                ...
                <form role="form" method="post" action="{{ url('customers/add') }}">
                    {{ csrf_field() }}
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" name="phone" class="form-control" id="exampleInputPassword1" placeholder="Phone Number" required="">
                    </div>
