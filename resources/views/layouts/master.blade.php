        ...
        <div class="modal-content bg-gradient-danger">
          ...
          <div class="modal-body">
            ...
            <div class="py-3 text-center">
              ...
              <h4 class="heading mt-4">Are you sure you want to delete this data?</h4>
            </div>
          ...
          <div class="modal-footer">
            <form action="" method="post">
              ...
              {{ method_field('delete') }}
              <p>
              <button type="submit" class="btn btn-danger btn-flat btn-sm menu-sidebar">Okay, Delete</button>
